...
export const routes:RouterConfig = [
  ...
  { path: 'dashbroad',component: components.DashbroadComponent,
    ...
    children: [
      ...
      { path: 'modify-store', component: components.ModifyStoreComponent, canDeactivate: [CanDeactivateGuard],canActivate: [AuthGuard], data: {title: '编辑门店'} },
      { path: 'add-store', component: components.AddStoreComponent, canDeactivate: [CanDeactivateGuard],canActivate: [AuthGuard], data: {title: '添加门店'} },
      ...
      { path: 'employee-add', component: components.EmployeeAddComponent, canDeactivate: [CanDeactivateGuard],canActivate: [AuthGuard], data: {title: '添加员工'} },
      { path: 'employee-edit', component: components.EmployeeEditComponent, canDeactivate: [CanDeactivateGuard],canActivate: [AuthGuard], data: {title: '编辑员工'} },
      { path: 'employee-list', component: components.EmployeeListComponent,canActivate: [AuthGuard], data: {title: '员工列表'} },
